...
#apps.twitter.com creat a new app to use the twiiter api see more at tweepy documentaion
...
tweetPerQry = input ( 'how many tweets do u want to grab : ')
...
print (tweet , "tweets found , the data have been written to ", filename)
print ("opinion score = " ,polarity)
if polarity >= 0:
    print("the people think positivly about this subject")
else:
    print ("the people think negativly about this subject")

#creating a table 
if lang == 'en':
    df = pd.read_csv(filename, encoding='ANSI')
    df.to_html( subject + 'feel.html' )
